...
bool Bot::sendPhoto(const QVariant &chatId, QFile * const file, QString caption, qint32 replyToMessageId, const GenericReply &replyMarkup)
{
    ParameterList params;
...
bool Bot::sendAudio(const QVariant &chatId, QFile * const file, qint64 duration, const QString &performer, const QString &title, qint32 replyToMessageId, const GenericReply &replyMarkup)
{
    ParameterList params;
...
bool Bot::sendAudio(const QVariant &chatId, const QString &fileId, qint64 duration, QString performer, QString title, qint32 replyToMessageId, const GenericReply &replyMarkup)
{
    ParameterList params;
    if(duration >= 0) params.insert("duration", HttpParameter(duration));
    if(!performer.isEmpty()) params.insert("performer", HttpParameter(performer));
...
bool Bot::sendDocument(const QVariant &chatId, QFile * const file, qint32 replyToMessageId, const GenericReply &replyMarkup)
{
...
bool Bot::sendSticker(const QVariant &chatId, QFile * const file, qint32 replyToMessageId, const GenericReply &replyMarkup)
{
...
bool Bot::sendVideo(const QVariant &chatId, QFile * const file, qint64 duration, QString caption, qint32 replyToMessageId, const GenericReply &replyMarkup)
{
    ParameterList params;
...
bool Bot::sendVideo(const QVariant &chatId, const QString &fileId, qint64 duration, QString caption, qint32 replyToMessageId, const GenericReply &replyMarkup)
{
    ParameterList params;
    params.insert("duration", HttpParameter(duration));
    params.insert("caption", HttpParameter(caption));
...
bool Bot::sendVoice(const QVariant &chatId, QFile * const file, qint64 duration, qint32 replyToMessageId, const GenericReply &replyMarkup)
{
    ParameterList params;
    params.insert("duration", HttpParameter(duration));
...
bool Bot::sendChatAction(const QVariant &chatId, const Bot::ChatAction &action)
{
    if(chatId.type() != QVariant::String && chatId.type() != QVariant::Int) {
        qCritical("Please provide a QString or int as chatId");
        return false;
...
bool Bot::answerCallbackQuery(const QVariant &callback_query_id, QString text, bool show_alert, QString url, quint32 cache_time)
{
    ParameterList params;
...
bool Bot::setWebhook(const QString &url, QFile * const certificate)
{
    ParameterList params;
...
bool Bot::_sendPayload(const QVariant &chatId, QFile * const filePayload, ParameterList params, qint32 replyToMessageId, const GenericReply &replyMarkup, const QString &payloadField, const QString &endpoint)
{
    if(chatId.type() != QVariant::String && chatId.type() != QVariant::Int)
    {
        qCritical("Please provide a QString or int as chatId");
...
{
    if(chatId.type() != QVariant::String && chatId.type() != QVariant::Int && chatId.type() != QVariant::UInt && chatId.type() != QVariant::LongLong && chatId.type() != QVariant::ULongLong) {
...
{
    QJsonObject obj = QJsonDocument::fromJson(json).object();
    return (!obj.isEmpty() && obj.value("ok").toBool());
}
